...
<html lang="en-US" dir="ltr">
  <head>
    ...
    <title><?php echo $title;?> | Watch Live &amp; On Demand</title>
  ...
  <div class="container">
    ...
    <div class="player center-block">
        <div class="layar" data-video="<?php if( isset($_GET['i']) ) : ?><?php echo "https://i.imgur.com/" . $_GET['i'] . ".jpeg";?><?php elseif( empty($_GET['i']) ) : ?><?php echo $url_webs;?>assets/gsilvers/images/backdrop.jpg<?php endif;?>">
            <!--modal-direct-auth-->
